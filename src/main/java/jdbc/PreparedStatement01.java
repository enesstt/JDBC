...
public class PreparedStatement01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //1. Örnek:
        // Prepared statement kullanarak company adı IBM olan number_of_employees değerini 9999
        // olarak güncelleyin.


        // 1. Adım: Prepared statemnet query'sini oluştur.
        String sql1 = "Update companies set number_of_employees= ? where company = ?";

        // 2. Adım: PreparedStatement objesini oluştur.
        PreparedStatement pst1 = con.prepareStatement(sql1);

        // 3. Adım:set...() mthodları ile ? işaretlerine değer atama
        pst1.setInt(1, 9999);
